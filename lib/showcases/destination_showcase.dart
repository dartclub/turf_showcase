...
class _DestinationShowcaseState extends State<DestinationShowcase> {
  ...
  LatLng get _dest {
    final origin = turf.Point(coordinates: turf.Position(_origin.longitude, _origin.latitude));
    final result = destination(origin, _distance, _bearing, _unit);
    return LatLng(
  ...
  Widget build(BuildContext context) {
    ...
    return ShowcaseFrame(
      hint: 'Drag the origin or change bearing/distance to see the destination move',
      map: fm.FlutterMap(
      ...
      resultPanel: ResultPanel(
        ...
        callRows: [
          kv('fn', 'destination(origin, distance, bearing, unit)'),
